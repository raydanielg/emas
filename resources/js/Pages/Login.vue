      ...
      <div class="bg-white/95 backdrop-blur rounded-xl shadow-xl border-t-4 border-emas-green p-8">
        <div class="flex flex-col items-center mb-6">
          ...
          <h2 class="text-2xl font-bold tracking-wide text-gray-900">
            <span class="text-emas-green lowercase">e</span><span>MAS</span>
        ...
        <form @submit="submit" class="space-y-5">
          <div>
            ...
            <div class="relative mt-1">
              ...
              <input v-model="username" id="username" type="text" required placeholder="Enter your username"
        ...
        <div class="mt-5 flex items-center justify-between text-sm">
          <a href="/password/forgot" class="font-semibold text-emas-green hover:text-emas-greenDark">Forgot password?</a>
